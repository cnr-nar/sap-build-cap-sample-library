...
service sap_build_cap_sample_library @(path: '/api/v1') {
    ...
    define type DataString  : String;
    define type DataInteger : Integer;
    define type DataNumber  : Double;
    ...
    @Core.Description: 'getListTodos'
    function getListTodos()                                                  returns DataListArray;
